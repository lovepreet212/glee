			...
			if(flag)
			{
                  ...
                  try
                  {
                      ...
                      try
                      {
                          ...
                          PreparedStatement mystatement=myconnection.prepareStatement("insert into add_service(service_name,pic,date,time,ip) values(?,?,?,?,?)");
                          mystatement.setString(1,service);
                          mystatement.setString(2,i);
                          mystatement.setString(3,dt);
                          mystatement.setString(4,tim);
                          mystatement.setString(5,ip);
