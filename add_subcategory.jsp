			...
			<div class="agile-contact-form">
				...
				<div class="col-md-6 contact-form-right">
					<div class="agileinfo-contact-form-grid">
						<form action="add_subcategory0.jsp" method="post" enctype="multipart/form-data">
       ...
       Class.forName("com.mysql.jdbc.Driver");
      ...
      catch(Exception e)
        {
            out.print(e);
                                                        ...
                                                        Enter Sub-Category<input type="text" name="subcategory" class="form-control" placeholder="Sub-Category" required="" >
                                                        Pic<input type="file" name="file" class="form-control"  required="">
