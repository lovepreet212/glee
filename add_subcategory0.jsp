...
<%
  ...
  boolean flag=false;
      String service="",category="",subcat="",path,i="",img="";
      int sid = 0;
      int cid = 0;
      int ids=0;
      // Date Fetch
          ...
          while (itr.hasNext())
            {
                ...
                if (item.isFormField())
                {
                    ...
                    {
                        cid=Integer.parseInt(value);//variable name                
                    }
                    if(itemName1.equals("subcategory")) //control's name - textbox name
                    {
			...
			if(flag)
			{
                  ...
                  try
                  {
                      ...
                      try
                      {
                          ...
                          PreparedStatement mystatement=myconnection.prepareStatement("insert into add_subcategory(service_id,category_id,subcategory_name,pic,date,time,ip) values(?,?,?,?,?,?,?)");
                          mystatement.setInt(1,sid);
                          mystatement.setInt(2,cid);
                          mystatement.setString(3,subcat);
                           mystatement.setString(4,i);
